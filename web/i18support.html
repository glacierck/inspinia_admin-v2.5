    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label" data-i18n="nav.dashboard">Dashboards</span> <span class="fa arrow"></span></a>
                ...
                <li>
                    <a href="layouts.html"><i class="fa fa-diamond"></i> <span class="nav-label" data-i18n="nav.layouts">Layouts</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label" data-i18n="nav.mailbox">Mailbox </span><span class="label label-warning pull-right">16/24</span></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="metrics.html"><i class="fa fa-pie-chart"></i> <span class="nav-label" data-i18n="nav.metrics">Metrics</span>  </a>
                </li>
                <li>
                    <a href="widgets.html"><i class="fa fa-flask"></i> <span class="nav-label" data-i18n="nav.widgets">Widgets</span></a>
                </li>
                <li>
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="i18support.html">i18 support</a></li>
                ...
                <li>
                    <a href="grid_options.html"><i class="fa fa-laptop"></i> <span class="nav-label" data-i18n="nav.gridoptions">Grid options</span></a>
                </li>
                <li>
                ...
                <li>
                    <a href="css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label" data-i18n="nav.animations">CSS Animations </span><span class="label label-info pull-right">62</span></a>
                </li>
                <li class="landing_link">
                    <a target="_blank" href="landing.html"><i class="fa fa-star"></i> <span class="nav-label" data-i18n="nav.landing">Landing Page</span> <span class="label label-warning pull-right">NEW</span></a>
                </li>
                <li class="special_link">
                    <a href="package.html"><i class="fa fa-database"></i> <span class="nav-label" data-i18n="nav.package">Package</span></a>
                </li>
            </ul>
                ...
                <div class="col-lg-8">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            ...
                            <a class="btn btn-white set_en "><img src="img/flags/16/United-States.png"> EN</a>
                            <a class="btn btn-white set_es"><img src="img/flags/16/Spain.png"> ES</a>
                            <a class="btn btn-white set_ch active"><img src="img/flags/16/China.png"> CH</a>
...
<script>
    ...
    $(document).ready(function (){
        ...
        $('.set_ch').on('click', function (){
            i18n.setLng('ch', function(){
                $('.i18container').i18n();
                $('#side-menu').i18n();
                $('.navbar-top-links').i18n();

                $('.set_ch').addClass('active');
                $('.set_en').removeClass('active');
                $('.set_es').removeClass('active');
            });
        })
